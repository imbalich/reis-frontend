...
import {
    ...
    type GetWarehouseInventoryDetails,
    type WarehouseInventoryFormImportParams
...
const [ImportModal, importModalApi] = useVbenModal({
    ...
    async onConfirm() {
        ...
        importModalApi.lock();
        try {
            const formValues = await importFormApi.getValues<WarehouseInventoryFormImportParams>();
